                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-3">
                    ...
                    {evento.stato === 'pianificata' && (
                      <Link href={`/eventi/${evento.id}/partecipa`} className="flex-1 inline-block text-center px-4 py-2 bg-white text-orange-500 font-medium border border-orange-200 rounded-lg shadow-sm hover:bg-orange-50 transition-all">
                        Partecipa
                      </Link>
                    )}
                  </div>
